...
const CHALS = {
    ...
    1: {
        ...
        start: E(1.5e58),
        effect(x) {
            let rank = x.softcap(30,4,1).floor()
    ...
    2: {
        ...
        effect(x) {
            ...
            let ret = x.mul(0.075).add(1).softcap(1.5,sp,0).sub(1)
            return ret
        },
        effDesc(x) { return "+"+format(x.mul(100))+"%"+(x.gte(0.5)?" <span class='soft'>(softcapped)</span>":"") },
    },
    3: {
    ...
    6: {
        ...
        start: E(1.989e38),
        effect(x) {
            let ret = x.mul(0.1).add(1).softcap(1.75,player.atom.elements.includes(39)?1:0.5,0).sub(1)
            return ret
        },
        effDesc(x) { return "+"+format(x)+"x"+(x.gte(0.75)?" <span class='soft'>(softcapped)</span>":"") },
    },
    7: {
